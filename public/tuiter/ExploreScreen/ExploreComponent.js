                ...
                <div class="flex-grow-1">
                    <div class="input-group border rounded-pill bg-white">
                        <span class="input-group-text bg-transparent border-0">
                            <i class="fa-solid fa-magnifying-glass pl-10 text-grey"></i> </span>
                        <input type="text" placeholder="Search Tuiter" id="wd-search-input" class="form-control border-0 bg-transparent text-secondary font-weight-bold" title="Search" />
                    </div>
                </div>
                <div class="ml-25">
        ...
        <div class="tab-content mt-2">
            <div class="tab-pane fade show active" id="for-you-panel" role="tabpanel" aria-labelledby="home-tab" type="button">
                ...
                <div class="overlay-img-text">
                    <span class="text-black-shade h2 font-weight-bold">SpaceX's Starship</span>
                </div>
            </div>
        </div>
